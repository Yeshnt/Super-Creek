...
const SYSTEM_PROMPT = [
  ...
  '- If someone sends an image, react to it warmly in character.',
].join('\n');
...
async function describeImage(imageUrl, userId) {
  addToHistory(userId, 'user', 'The user sent an image. Please react to it warmly in character as Super Creek.');
